...
Once the runtime starts, you can access the project at [http://localhost:8080/JAX-Task](http://localhost:8080/JAX-Task).
...
```
./mvnw clean package
docker build -t JAX-Task:v1 .
```

You can then run the Docker image by executing:

```
docker run -it --rm -p 8080:8080 JAX-Task:v1
```
